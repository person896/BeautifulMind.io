...
RUN git clone https://github.com/person896/BeautifulMind.io.git /opt/beautifulmind/www
RUN cd /opt/beautifulmind/www
RUN cd /opt/beautifulmind/www && git checkout production

RUN cd /opt/beautifulmind/www/beautifulmind
